...
@section('content')
    ...
    <div class="row g-3">
        <div class="alert alert-success alert-custom" id="successAlert">
            <i data-lucide="check-circle" style="width:18px;height:18px;"></i> Organization created successfully!
        </div>
        ...
        <div class="col-md-12">
            <div class="dashboard-card h-100">
                <div class="card-header">
                    ...
                    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addOrganizationModal">
                        <i data-lucide="plus-circle" style="width:18px;height:18px;"></i> Add Organization
                    </button>
                </div>
                <div class="card-body no-padding" style="overflow-x:auto;">
                    <table class="table-activities" aria-label="Recent activities table" id="organizationTable">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Organization</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-success" href="#" data-bs-toggle="modal"
                                            ...
                                            onclick="$('#id').val('{{ $organization->id }}'); $('#organizationName').val('{{ $organization->name }}'); ">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header border-bottom-0 px-4 pt-4 pb-2">
                    <h5 class="modal-title fw-bold" id="addOrganizationModalLabel">
                        <i data-lucide="calendar-plus" style="width:20px;height:20px; margin-right: 6px;"></i> New
                        Organization
                    </h5>
                ...
                <div class="modal-body px-4 pt-2 pb-3">
                    <form id="organizationForm" novalidate>
                        ...
                        <!-- Organization Name -->
                        <div class="mb-3">
                            <label for="organizationName" class="form-label fw-semibold small">
                                <i data-lucide="building" style="width:14px;height:14px;"></i> Organization Name
                            </label>
                            <div class="input-group">
                                <span class="input-group-text bg-light">
                                    <i data-lucide="book-open" style="width:18px;height:18px;"></i>
                                </span>
                                <input type="text" name="name" class="form-control" id="organizationName"
                                    placeholder="e.g., Main Organization" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary" id="submitOrganizationBtn">
    ...
    <script>
        $(document).ready(function() {
            $('#organizationForm').on('submit', async function(e) {
                ...
                const id = $('#id').val();
                const name = $('#organizationName').val().trim();
                if (!name) {
                    $('#modalErrorMessage').text('Organization Name is required.');
